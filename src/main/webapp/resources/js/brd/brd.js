...
brd = (()=>{
	...
	let _, js, css, img, brd_vue_js,navi_js, navi_vue_js,page_vue_js,brd_js,compo_vue_js
	let init =()=>{
		_ = $.ctx()
		js = $.js()
		css = $.css()
	...
	let recent_updates=x=>{
        ...
        $.getJSON(_+'/articles/page/'+x.page+'/size/'+x.size,d =>{
      		...
      		$('<form id ="paging_form" class="form-inine my-2 my-lg-0">'+
